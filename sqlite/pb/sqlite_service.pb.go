...
type QueryRequest_Stmts struct {
	// Typed CST — the server renders it back to SQL text (via
	// sqliteembed.RenderSQL) and executes it. Fully supported.
